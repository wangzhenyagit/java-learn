...
public enum JSONObjectParseTest 
{
	INSTANCE;
	...
	public static void main(String args[]) {
		...
		JSONObjectParseTest.INSTANCE.TestJSONObjectParse(jsonStringLong);
		JSONObjectParseTest.INSTANCE.TestJSONObjectParse(jsonStringShort);
	}
}
